    ...
    <div className="min-h-screen bg-background pb-[calc(5rem+env(safe-area-inset-bottom,0px))] sm:pb-0">
      ...
      <AnimatePresence>
        {showScrollTop && (
          <motion.button
            onClick={scrollToTop}
            className="fixed bottom-[calc(5rem+env(safe-area-inset-bottom,0px))] sm:bottom-6 right-6 z-50 p-3 rounded-full bg-wine text-white shadow-lg shadow-wine/25 hover:bg-wine-dark hover:shadow-xl transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wine focus-visible:ring-offset-2"
