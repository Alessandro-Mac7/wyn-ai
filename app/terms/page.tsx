...
import { AnimatedPageContent, AnimatedSection, AnimatedParagraph } from '@/components/gdpr/AnimatedPageContent'
...
export default function TermsPage() {
  return (
    <AnimatedPageContent title="Termini di Servizio - WYN">
