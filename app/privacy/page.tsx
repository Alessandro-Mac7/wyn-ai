...
import { AnimatedPageContent, AnimatedSection, AnimatedParagraph, AnimatedTable } from '@/components/gdpr/AnimatedPageContent'
...
export default function PrivacyPage() {
  return (
    <AnimatedPageContent title="Informativa Privacy - WYN">
      <AnimatedParagraph className="text-sm text-amber-500 bg-amber-500/10 px-4 py-3 rounded-lg">
